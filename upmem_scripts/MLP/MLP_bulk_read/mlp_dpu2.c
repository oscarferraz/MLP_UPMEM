...
__mram float d_test1[60*60];
__mram float d_test2[60*60];
__mram float d_res[60*60];


__mram_ptr float* aux[60*60];



__dma_aligned float cache1[60*50]; // cache in WRAM to perform transfer
__dma_aligned float cache2[60*40]; // cache in WRAM to perform transfer
