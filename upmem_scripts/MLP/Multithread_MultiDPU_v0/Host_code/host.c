...
#define KDOT_SIGMOID_BINARY "../DPU_code/KDOT_SIGMOID"
#define KDOT_SIGMOID2_BINARY "/home/pribeiro/upmem_scripts/MLP/Multithread_MultiDPU_v0/DPU_code/KDOT_SIGMOID2"
