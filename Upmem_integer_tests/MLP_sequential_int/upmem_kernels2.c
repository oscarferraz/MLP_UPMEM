...
int* kMartixByMatrixElementwise(const int width, const int height, int const *m1, int const *m2, int *output)
{
...
int* kMartixSubstractMatrix(const int width, const int height, int const *m1, int const *m2, int *output)
{
	for(int i = 0; i < width * height; i+=1)
	{
		output[i] = m1[i] - m2[i];
...
int* kSigmoid(const int width, const int height, int const *m1, int *output)
{
	for(int i = 0; i < width * height; i+=1)
	{
...
int* kSigmoid_d(const int width, const int height, int const *m1, int *output)
{
	for(int i = 0; i < width * height; i+=1)
	{
...
int* kDot(int const *m1, int const *m2, int *output, const int m1_rows, const int m1_columns, const int m2_columns)
{	
	int t_output;
...
int* kDot_m1_m2T(int const *m1, int const *m2, int *output, const int m1_rows, const int m1_columns, const int m2_rows)
{
	int t_output;
...
int* kDot_m1T_m2(const int lr, int const *m1, int const *m2, int *output, const int m1_rows, const int m1_columns, const int m2_columns)
{
	int t_output;
...
void kFit(
		 int const *X, const int X_w,  const int X_h,
		 int const *y, const int y_w,
		 int *l1, const int l1_w,
		 int *l_1_d,
		 int *pred, int *pred_d,
		 int *W0,
		 int *W1,
		 ...
		 const int lr)
{
    ...
    for (int i = 0; i < X_h; i++)
    {
			printf("Prediction[%i] : %i True Value[%i] : %i Error[%i] : %i\n", i, pred[i], i, y[i], i, pred[i] - y[i]);
		}
}
